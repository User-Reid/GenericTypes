...
List<FullName> listOfNames = new List<FullName>() {
...
var sorted = new SortedList<FullName>(listOfNames);
foreach (FullName name in sorted.Items)
{
...
public class SortedList<T> where T : IComparable<T>
  ...
  {
    var resultOfLastName = LastName.CompareTo(other.LastName);
    if (LastName.CompareTo(other.LastName) != 0)
    {
      return resultOfLastName;
    }
